...
### 加班举证方式
1、加班前可以搜集的证据，比如单位领导通过聊天工具通知加班，在内网上公布加班人员名单，单位张贴书面加班通知，写有作息时间的规章制度、考勤制度等，都可以对其进行截屏、拍照或复制留存。

2、是可以保留交接班记录、领取材料记录、工作流程记录，加班时工作邮件或电话往来的一些记录;注意对自己所做的工作内容进行记录，将开会时间、地点、参加人数、会议内容记录下来。

3、是加班后，劳动者要争取有同事出庭作证;要保留加班后向单位报销出租车费及报销理由的复印件，以及主张加班费时的录音、聊天记录等视听材料。

4、提取工作电脑的开关机时间记录，（windows系统）管理工具-事件查看器

5、源代码提交记录，自证加班时间。

6、可以通过电脑自带摄像头，或者放置摄像头定时拍照自证工作时间，仅自拍。
